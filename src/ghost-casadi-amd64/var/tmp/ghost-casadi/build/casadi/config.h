...
#define CASADI_GIT_REVISION "2aa1eb217a245856faab5002d339dca6ed9ebc38"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.6.3-65.2aa1eb217"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER_FLAGS " -fopenmp -DWITH_OPENMP -pthread -fPIC    -DUSE_CXX11 -DHAVE_MKSTEMPS -DCASADI_WITH_THREAD -DWITH_DEEPBIND -DCASADI_MAJOR_VERSION=3 -DCASADI_MINOR_VERSION=6 -DCASADI_PATCH_VERSION=3 -DCASADI_IS_RELEASE=0 -DCASADI_VERSION=31 -D_USE_MATH_DEFINES -D_SCL_SECURE_NO_WARNINGS -DWITH_DL -DWITH_DEPRECATED_FEATURES -DCASADI_DEFAULT_COMPILER_PLUGIN=shell"  // NOLINT(whitespace/line_length)
